...
export const homeDescription = 'Amante de la <strong>programación y el deporte</strong>, siempre he estado metido detrás del muro trabajando de Backend developer con Java. Ahora, directo a full stack. Mis 6 años de experiencia me han preparado para adaptarme a las situaciones y peculiaridades de cada proyecto, así como a tirar del hilo en busca de la mejor solución.\n\nEn cada uno de mis proyectos me he dedicado al desarrollo de evolutivos y correctivos. Así como de hablar con el cliente sobre la opción más viable acorde a lo que necesitaba en cada momento.';
